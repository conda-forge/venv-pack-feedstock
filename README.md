About venv-pack-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/venv-pack-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/jcrist/venv-pack

Documentation: https://jcrist.github.io/venv-pack/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3633&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/venv-pack-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `venv-pack` can be installed with `conda`:
...
```
mamba install venv-pack
```

It is possible to list all of the versions of `venv-pack` available on your platform with `conda`:
...
```
mamba search venv-pack --channel conda-forge
```
...
mamba repoquery search venv-pack --channel conda-forge

# List packages depending on `venv-pack`:
mamba repoquery whoneeds venv-pack --channel conda-forge

# List dependencies of `venv-pack`:
mamba repoquery depends venv-pack --channel conda-forge
```
